...
$BackupRoot = Join-Path $ProjectRoot ".patch_backups\v1.6.1_$Timestamp"
New-Item -ItemType Directory -Path $BackupRoot -Force | Out-Null

$Items = @(
    "README_V1_6_1_STANDALONE_FILL.md",
    "build_app.py",
    "build_release.ps1",
...
Write-Host "Đã cập nhật Import Localize lên v1.6.1." -ForegroundColor Green
Write-Host "Backup file cũ: $BackupRoot" -ForegroundColor DarkGray
Write-Host "Fill Translate_Data hiện là nút độc lập, không còn tự chạy sau Import." -ForegroundColor Green
