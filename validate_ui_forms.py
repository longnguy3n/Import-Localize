...
REQUIRED = {
    "main_window.ui": {
        ...
        "stopButton",
        "progressBar",
        "fillTranslateDataButton",
        "downloadExportTabsButton",
        "logCard",
        "logPlaceholder",
        "settingsButton",
    },
    "target_settings.ui": {"targetCard", "targetIconLabel", "sheetUrlEdit", "targetModeCombo", "singleSheetNameEdit", "valueInputCombo"},
    "settings_dialog.ui": {
        "dialogCard",
        "dialogIconLabel",
        "oauthClientPathEdit",
